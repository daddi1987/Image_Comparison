...
E5 = tk.Scale(window, from_=0.9, to=1,length=450, resolution= 0.00001, orient="horizontal")
...
E7 = tk.Button(window, text="COMPARE", fg="Blue", width= 10, command="")
...
messagebox.showinfo("Finish","Completed Successfully")
